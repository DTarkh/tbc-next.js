...
const NavPanel = ({onAdd}) => {
  ...
  <h2 className="text-lg font-semibold text-gray-700 mb-4">Product Panel</h2>
  ...
  <div className="mb-4">
    ...
    <select className="w-full p-2 mt-2 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500">
